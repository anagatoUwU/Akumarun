...
Game_CharacterBase.prototype.setNewParameters = function() {
    this._zoomData[0] = this.setCharNewPar(this._zoomData[0],this._zoomData[2],0);
	this._zoomData[1] = this.setCharNewPar(this._zoomData[1],this._zoomData[3],0);
	this._rotationData[0] = this.setCharNewPar(this._rotationData[0],this._rotationData[1],0);
};
